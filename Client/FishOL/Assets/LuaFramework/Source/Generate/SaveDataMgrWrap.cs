...
public class SaveDataMgrWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(SaveDataMgr), typeof(UnityEngine.MonoBehaviour));
	...
	static int getFloat(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				SaveDataMgr obj = (SaveDataMgr)ToLua.CheckObject<SaveDataMgr>(L, 1);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: SaveDataMgr.getFloat");
			}
		}
		catch (Exception e)
		{
	...
	static int getInt(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: SaveDataMgr.getInt");
			}
		}
		catch (Exception e)
		{
	...
	static int getString(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: SaveDataMgr.getString");
			}
		}
		catch (Exception e)
		{
	...
	static int getBool(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: SaveDataMgr.getBool");
			}
		}
		catch (Exception e)
		{
