...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(ResMgr.LoadObjectCompleteHandler), factory.ResMgr_LoadObjectCompleteHandler);
		dict.Add(typeof(ResMgr.LoadGameObjectCompleteHandler), factory.ResMgr_LoadGameObjectCompleteHandler);
		...
		DelegateTraits<ResMgr.LoadObjectCompleteHandler>.Init(factory.ResMgr_LoadObjectCompleteHandler);
		DelegateTraits<ResMgr.LoadGameObjectCompleteHandler>.Init(factory.ResMgr_LoadGameObjectCompleteHandler);
		...
		TypeTraits<ResMgr.LoadObjectCompleteHandler>.Init(factory.Check_ResMgr_LoadObjectCompleteHandler);
		TypeTraits<ResMgr.LoadGameObjectCompleteHandler>.Init(factory.Check_ResMgr_LoadGameObjectCompleteHandler);
		...
		StackTraits<ResMgr.LoadObjectCompleteHandler>.Push = factory.Push_ResMgr_LoadObjectCompleteHandler;
		StackTraits<ResMgr.LoadGameObjectCompleteHandler>.Push = factory.Push_ResMgr_LoadGameObjectCompleteHandler;
	...
	class ResMgr_LoadObjectCompleteHandler_Event : LuaDelegate
	{
		public ResMgr_LoadObjectCompleteHandler_Event(LuaFunction func) : base(func) { }
		public ResMgr_LoadObjectCompleteHandler_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public ResMgr.LoadObjectCompleteHandler ResMgr_LoadObjectCompleteHandler(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			ResMgr.LoadObjectCompleteHandler fn = delegate(UnityEngine.Object param0) { };
			return fn;
		}

		if(!flag)
		{
			ResMgr_LoadObjectCompleteHandler_Event target = new ResMgr_LoadObjectCompleteHandler_Event(func);
			ResMgr.LoadObjectCompleteHandler d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			ResMgr_LoadObjectCompleteHandler_Event target = new ResMgr_LoadObjectCompleteHandler_Event(func, self);
			ResMgr.LoadObjectCompleteHandler d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_ResMgr_LoadObjectCompleteHandler(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(ResMgr.LoadObjectCompleteHandler), L, pos);
	}

	void Push_ResMgr_LoadObjectCompleteHandler(IntPtr L, ResMgr.LoadObjectCompleteHandler o)
	{
		ToLua.Push(L, o);
	}

	class ResMgr_LoadGameObjectCompleteHandler_Event : LuaDelegate
	{
		public ResMgr_LoadGameObjectCompleteHandler_Event(LuaFunction func) : base(func) { }
		public ResMgr_LoadGameObjectCompleteHandler_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public ResMgr.LoadGameObjectCompleteHandler ResMgr_LoadGameObjectCompleteHandler(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			ResMgr.LoadGameObjectCompleteHandler fn = delegate(AssetObject param0) { };
			return fn;
		}

		if(!flag)
		{
			ResMgr_LoadGameObjectCompleteHandler_Event target = new ResMgr_LoadGameObjectCompleteHandler_Event(func);
			ResMgr.LoadGameObjectCompleteHandler d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			ResMgr_LoadGameObjectCompleteHandler_Event target = new ResMgr_LoadGameObjectCompleteHandler_Event(func, self);
			ResMgr.LoadGameObjectCompleteHandler d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_ResMgr_LoadGameObjectCompleteHandler(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(ResMgr.LoadGameObjectCompleteHandler), L, pos);
	}

	void Push_ResMgr_LoadGameObjectCompleteHandler(IntPtr L, ResMgr.LoadGameObjectCompleteHandler o)
	{
		ToLua.Push(L, o);
	}
